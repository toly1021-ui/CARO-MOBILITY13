...
(function(){
  ...
  function injectCss(){
    ...
    .nh-ev .nh-badge{ display:inline-block; padding:4px 11px; border-radius:10px; font-size:9.5px; font-weight:800; background:var(--p1-accent-d,#57616d); color:#fff; }
