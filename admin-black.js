...
(function(){
  ...
  st.textContent=
    ...
    +'.bbody input,.bbody select{width:100%;background:var(--panel2);border:1px solid var(--border2);color:var(--txt);border-radius:9px;padding:10px 12px;font-size:13px;box-sizing:border-box;}'
