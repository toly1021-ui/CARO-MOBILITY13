...
(function(){
  ...
  const TERMS_CONTENT = {
    '서비스 이용약관': {
      ...
      body: `
        ...
        <h4>제2조 (용어의 정의)</h4>
        <ul>
          <li>"서비스"란 회사가 운영하는 모바일 앱 및 웹사이트를 통해 제공되는 차량 대여 및 부가서비스를 의미합니다.</li>
          <li>"회원"이란 본 약관에 동의하고 회사와 이용계약을 체결한 자를 말합니다.</li>
          <li>"차량"이란 회사가 보유하고 회원에게 대여하는 자동차를 말합니다.</li>
          <li>"대여 기간"이란 회원이 차량을 인수한 시점부터 반납한 시점까지를 말합니다.</li>
        </ul>
        ...
        <h4>제4조 (회원가입 및 자격)</h4>
        <ul>
          <li>만 21세 이상이며 유효한 운전면허를 보유한 자</li>
        ...
        <ul>
          ...
          <li>회사가 정한 이용수칙 준수</li>
        </ul>
        
        <h4>제6조 (서비스 이용 제한 및 계약 해지)</h4>
        <p>회사는 회원이 본 약관을 위반한 경우 사전 통지 후 서비스 이용을 제한하거나 계약을 해지할 수 있습니다. 중대한 위반 시에는 즉시 해지가 가능합니다.</p>
        
        <h4>제7조 (손해배상)</h4>
        <p>회원이 본 약관 또는 법령을 위반하여 회사에 손해를 끼친 경우 그 손해를 배상해야 합니다. 단, 천재지변 등 불가항력에 의한 손해는 제외됩니다.</p>
        
        <h4>제8조 (분쟁 해결 및 관할법원)</h4>
    ...
    '개인정보처리방침': {
      title: '개인정보처리방침',
      body: `
        <p>CARO MOBILITY(이하 "회사")는 「개인정보 보호법」(법률 제20897호, 2025.10.2 시행) 등 관련 법령을 준수하며, 회원의 개인정보를 보호하기 위해 다음과 같이 처리방침을 수립·공개합니다.</p>
        
        <h4>제1조 (수집 항목 및 방법)</h4>
        <ul>
          <li><strong>회원가입 시:</strong> 성명, 생년월일, 휴대전화번호, 이메일, 운전면허 정보(번호·종별·유효기간)</li>
          <li><strong>서비스 이용 시:</strong> 차량 이용 기록, 결제정보, 위치정보, 사고/위반 정보</li>
          <li><strong>수집 방법:</strong> 회원가입 양식 입력, 본인확인 절차, 서비스 이용 과정에서 자동 생성</li>
        </ul>
        ...
        <h4>제4조 (제3자 제공)</h4>
        <p>회사는 회원의 동의 없이 개인정보를 제3자에게 제공하지 않습니다. 다만, 법령에 의한 수사기관의 요청 또는 법원의 영장이 있는 경우는 예외로 합니다.</p>
        ...
        <h4>제6조 (안전성 확보 조치)</h4>
        <p>회사는 개인정보의 안전한 처리를 위해 다음과 같은 조치를 시행합니다.</p>
        <ul>
          <li>관리적 조치: 개인정보보호책임자 지정, 임직원 교육</li>
          <li>기술적 조치: 접근권한 관리, 암호화, 보안 솔루션 적용</li>
    ...
    '위치기반서비스 이용약관': {
      ...
      body: `
        ...
        <ul>
          <li>회사는 수집한 위치정보를 서비스 제공 목적으로만 이용합니다.</li>
          <li>회원의 사전 동의 없이 제3자에게 제공하지 않습니다.</li>
          <li>예외: 응급상황(긴급구조) 시 회원이 동의한 경우, 법령에 의한 수사기관 요청</li>
        </ul>
        ...
        <ul>
          <li>위치정보 수집·이용 동의의 일부 또는 전부 철회권</li>
          <li>위치정보의 일시적 중지 요구권</li>
          <li>위치정보 열람·고지·정정 요구권</li>
        </ul>
        
        <h4>제7조 (8세 이하 아동 등의 보호의무자 권리)</h4>
    ...
    '자동차 대여 표준약관': {
      title: '자동차 대여 표준약관',
      body: `
        <p>본 약관은 「공정거래위원회 자동차대여 표준약관(제10064호)」을 기반으로 작성되었으며, 「여객자동차 운수사업법」 제34조 등 관계 법령을 준수합니다.</p>
        
        <h4>제1조 (목적)</h4>
        <p>본 약관은 CARO MOBILITY(이하 "회사")가 제공하는 자동차 대여 서비스 이용에 관한 회사와 임차인 간의 권리·의무를 규정함을 목적으로 합니다.</p>
        
        <h4>제2조 (대여 자격)</h4>
        <ul>
          <li>만 21세 이상 (외제·고급 차량은 만 26세 이상)</li>
          <li>운전면허 취득 1년 이상 경과</li>
          <li>면허정지·취소 처분 중이 아닐 것</li>
          <li>유효한 신분증 소지자</li>
        </ul>
        
        <h4>제3조 (대여 요금 및 결제)</h4>
        <ul>
          <li>요금은 시간 단위로 산정되며 회사가 정한 요금표에 따릅니다.</li>
          <li>예약 시점에 결제가 진행됩니다.</li>
          <li>면책상품 가입 시 자기부담금이 적용됩니다.</li>
        </ul>
        
        <h4>제4조 (차량의 인수 및 반납)</h4>
        <ul>
          <li>임차인은 인수 시 차량 상태를 확인하고 이상 시 즉시 통보해야 합니다.</li>
          <li>약정 시간·장소에 반납해야 하며, 지연 시 추가 요금이 부과됩니다.</li>
          <li>연료량은 인수 시 수준을 유지해야 하며, 부족분은 청구됩니다.</li>
        </ul>
        ...
        <ul>
          ...
          <li>차량 개조 또는 외관 손상</li>
          <li>차량의 양도·담보 제공</li>
        </ul>
        
        <h4>제6조 (사고 시 처리)</h4>
        <ul>
          <li>사고 발생 시 즉시 회사 및 보험사에 신고 (도로교통법 제54조)</li>
          <li>임차인 귀책 사고: 자기부담금 한도 내 손해배상</li>
          <li>휴차손해: <strong>일일대여요금의 50%</strong> (공정위 표준약관 기준)</li>
          <li>사고 후 임의 수리 금지</li>
        </ul>
        
        <h4>제7조 (계약의 해지 및 환불)</h4>
        <ul>
          <li>대여 시작 전 청약철회 가능 (전자상거래법 제17조)</li>
          <li>환불 처리: 결제일로부터 3영업일 이내 (전자상거래법 제18조)</li>
          <li>대여 시작 후 중도 해지 시 회사 정책에 따른 위약금 적용</li>
        </ul>
        
        <h4>제8조 (보험 적용)</h4>
        <p>회사 차량은 「자동차손해배상보장법」에 따른 책임보험 및 종합보험에 가입되어 있습니다. 자기부담금 및 면책상품은 별도 안내 참조.</p>
    ...
    '마케팅 정보 수신 동의': {
      ...
      body: `
        ...
        <h4>제3조 (야간 수신 동의 - 별도 동의 필요)</h4>
        <p>정보통신망법 제50조 제3항에 따라 <strong>오후 9시부터 오전 8시까지</strong>의 광고성 정보 전송에는 별도의 사전 동의가 필요합니다. 본 동의는 일반 마케팅 동의와 분리되어 있으며, 동의하지 않아도 일반 마케팅 정보는 받을 수 있습니다.</p>
        ...
        <ul>
          ...
          <li>회사는 철회 요청을 지체 없이 처리하고 결과를 통지합니다.</li>
        </ul>
        
        <h4>제5조 (수신 동의 거부에 따른 안내)</h4>
        <p>마케팅 수신 동의를 거부하셔도 서비스 이용에는 제한이 없습니다. 다만 이벤트·할인 등의 혜택 정보를 받아보실 수 없으므로 신중히 결정해 주시기 바랍니다.</p>
        
        <h4>제6조 (위반 시 처벌)</h4>
        <p>정보통신망법 제74조에 따라 회사가 회원의 동의 없이 광고성 정보를 전송한 경우 3천만 원 이하의 과태료가 부과될 수 있습니다.</p>
    ...
    '전자금융거래 이용약관': {
      title: '전자금융거래 이용약관',
      body: `
        <p>본 약관은 「전자금융거래법」 및 「여신전문금융업법」에 따라 작성되었습니다.</p>
        
        <h4>제1조 (목적)</h4>
        <p>본 약관은 CARO MOBILITY가 제공하는 전자금융거래 서비스의 이용에 관한 사항을 규정함을 목적으로 합니다.</p>
        ...
        <h4>제3조 (결제 처리 및 카드 정보 관리)</h4>
        <ul>
          <li>회사는 전자금융업자(토스페이먼츠 등)와 제휴하여 결제를 처리합니다.</li>
          <li>카드 정보는 PG사가 PCI-DSS 규정에 따라 토큰화하여 안전하게 보관합니다.</li>
          <li>회사는 카드번호 일부(****-****-****-XXXX)와 카드사 명칭만 보유합니다.</li>
        </ul>
        
        <h4>제4조 (오류의 정정 - 전자금융거래법 제8조)</h4>
        <ul>
          <li>회원은 거래 오류를 안 때부터 즉시 회사에 정정을 요구할 수 있습니다.</li>
          <li>회사는 2주 이내에 조사하여 결과를 통보합니다.</li>
          <li>정정 사유 발견 시 즉시 처리합니다.</li>
        </ul>
        
        <h4>제5조 (환불 처리)</h4>
        <ul>
          <li>신용카드: 카드사 영업일 기준 <strong>3~5일 이내</strong></li>
          <li>계좌이체: 영업일 기준 <strong>1~3일 이내</strong></li>
          <li>간편결제: PG사 정책에 따라 즉시~3영업일</li>
          <li>크레딧/포인트: 즉시 복원</li>
        </ul>
        
        <h4>제6조 (회사의 책임 - 전자금융거래법 제9조)</h4>
        <ul>
          <li>접근매체의 위·변조로 발생한 사고: 회사 책임</li>
          <li>전산 장애로 발생한 사고: 회사 책임</li>
          <li>해킹 등 전자적 침해에 의한 사고: 회사 책임 (단, 회원의 고의·중과실 제외)</li>
        </ul>
        
        <h4>제7조 (회원의 의무)</h4>
        <ul>
          <li>접근매체(카드·비밀번호) 관리 의무</li>
          <li>제3자에게 접근매체 양도·대여 금지</li>
          <li>위반 시 회원이 책임 부담</li>
        </ul>
        
        <h4>제8조 (분쟁 처리)</h4>
        <ul>
          <li>회사 분쟁 처리: 1588-0000 / privacy@caromobility.com</li>
          <li>금융감독원 분쟁조정위원회 신청 가능 (전자금융거래법 제27조)</li>
  ...
  /* ─── 약관 클릭 시 notice-modal 사용해서 표시 ─── */
  document.addEventListener('click', function(e){
    const target = e.target.closest('.apd-terms-item');
    if(!target) return;
    
    // 클릭한 약관 이름 추출
    const nameEl = target.querySelector('.apd-terms-name');
    if(!nameEl) return;
    
    const name = nameEl.textContent.trim();
    
    // 매칭되는 약관 찾기
    let content = TERMS_CONTENT[name];
    
    // 정확히 일치하지 않으면 부분 매치
    if(!content){
      for(const key in TERMS_CONTENT){
        if(key.includes(name) || name.includes(key.replace(/\s/g, ''))){
          content = TERMS_CONTENT[key];
          break;
        }
      }
    }
  ...
  console.log('[CARO] 약관 6종 콘텐츠 적용 완료 - 2025/2026 현행 법령 기준');
})();
